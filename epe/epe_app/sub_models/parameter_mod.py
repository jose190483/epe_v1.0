...
from ..models import MyUser,status_Info,owner_info,digital_source_info,equipment_shortInfo,equipmentInfo,system_short_Info,system_Info,unit_type_info,prameter_definition_info,uom_info,parameter_definition_lov_info
...
class prameter_info(models.Model):
    ...
    p_system_short=models.CharField(max_length=100, null=True, default='')
    ...
    p_equipment_short=models.CharField(max_length=100, null=True, default='')
    p_status=models.ForeignKey(status_Info,on_delete=models.PROTECT,null=True,blank=True,default=1)
    p_parameter_name_combo=models.CharField(max_length=300,null=True,blank=True)
    p_digital_source = models.ManyToManyField(digital_source_info,blank=True)
    p_owner = models.ManyToManyField(owner_info, blank=True)
